...
function Myprofile2()
{
   ...
   const[myallconetentofinstamidnav, setmyallconetentofinstamidnav]=useState( <Mysavedpost></Mysavedpost>);

  const mycontent1 = () =>
  {
    setmyallconetentofinstamidnav(
